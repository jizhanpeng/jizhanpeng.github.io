...
![image-20241217110851267](/img/T01.png)

Parallel Stream Convolution Model

![image-20241217111655463](/img/T02.png)

CTC-Sub-pixel Convolution Model

![image-20241217112014520](/img/T03.png)
...
![image-20241216110403682](/img/T04.png)

损失

![image-20241216132002525](/img/T05.png)

![image-20241216132706657](/img/T06.png)
...
![image-20241216184827362](/img/T07.png)

引入了梯度的损失

![image-20241216191237628](/img/T08.png)
...
![image-20241218175416641](/img/T09.png)

![image-20241218175433082](/img/T10.png)

损失函数：

![image-20241218180110513](/img/T11.png)

![image-20241218182646611](/img/T12.png)

![image-20241218182545574](/img/T13.png)

![image-20241218182816859](/img/T14.png)
...
![image-20241215140700782](/img/T15.png)

提出了一个多阶段（三）策略非常有意思。

![image-20241215142457540](/img/T16.png)
...
![image-20241215115735439](/img/T17.png)

核心就在于做了空间层面和通道层面的解耦。（如果输入：3 * 3 * 3;对于普通卷积：3 * 3 * 3 * 4;对于解耦后的卷积：3 * 3 * 3,1 * 1 * 3 * 4）

![image-20241215115900222](/img/T18.png)
...
![image-20241218143124116](/img/T19.png)
...
![image-20241214131702007](/img/T20.png)

const是一个矩阵，值全为1（或者其他），用来作为StyleGAN2的输入。

AdaInN实际上是一个特征融合模块计算公式如下：

![image-20241214132213630](/img/T21.png)

TP-Guided SR Block:通道维度拼接，然后进行投影。

引入了一个新的loss：

![image-20241214134057110](/img/T22.png)
...
![image-20241213151931443](/img/T23.png)
...
2. 双线性插值算法
   ...
   ![image-20241213132353415](/img/T24.png)
...
3. 双三次插值算法
   ...
   ![image-20241213133403378](/img/T25.png)
...
6. 梯度场
   ...
   ![image-20241216191503232](/img/T26.png)

   水平方向上（右边减左边），相邻像素的差值为：

   ![image-20241216191541565](/img/T27.png)

   垂直方向上（上面减下面），相邻像素的差值为：

   ![image-20241216191713868](/img/T28.png)

   梯度场由水平和垂直梯度组成，记为：

   ![image-20241216191741856](/img/T29.png)
